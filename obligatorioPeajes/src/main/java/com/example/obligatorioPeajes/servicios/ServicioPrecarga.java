...
public class ServicioPrecarga {
	...
	public void cargarDatosIniciales() {
		...
		// Simular Tránsito
		sistemaTransito.registrarTransito("ABC123", "Puesto Central",
				new DateTime(LocalDateTime.of(2024, 6, 1, 8, 30)));
		...
		sistemaTransito.registrarTransito("MOTO2", "Puesto Central",
				new DateTime(LocalDateTime.of(2024, 6, 1, 12, 30)));
		sistemaTransito.registrarTransito("CAMIONETA1", "Puesto Este",
				new DateTime(LocalDateTime.of(2024, 6, 1, 13, 15)));
		sistemaTransito.registrarTransito("CAMIONETA2", "Puesto Este",
				new DateTime(LocalDateTime.of(2024, 6, 1, 14, 0)));
