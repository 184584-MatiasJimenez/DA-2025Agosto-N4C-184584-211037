...
public class ControladorLogin {
    ...
    public List<Respuesta> ingresoPropietario(HttpSession session, @RequestParam String cedula, @RequestParam String contrasenia) throws UsuarioException {
        ...
        Sesion sesion  = fachada.login(cedula, contrasenia);
    ...
    @PostMapping("/ingresoAdministrador")
    public List<Respuesta> ingresoAdministrador(HttpSession session, @RequestParam String cedula,
